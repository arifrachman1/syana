                        ...
                        children: <Widget>[
                          ...
                          Container(
                            child: Column(
                              children: <Widget>[
                                Text(
                                  _homeDataModel.myTeamPackageSentToday
                                      .toString() ??
                                      '1',
                                  style: TextStyle(
                                    color: AppTheme.text_light,
                        ...
                        children: <Widget>[
                          Container(
                            child: Column(
                              children: <Widget>[
                                Text(
                                  _homeDataModel.grandTotalPoint.round().toString() ??
                                      '138922',
                                  style: TextStyle(
                                    color: AppTheme.text_light,
                                    fontSize: 17,
                        ...
                        children: <Widget>[
                          Container(
                            child: Column(
                              children: <Widget>[
                                Text(
                                  _homeDataModel.grandTotalPointTeam.round()
                                      .toString() ??
                                      '138922',
                                  style: TextStyle(
                                    color: AppTheme.text_light,
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Flexible(
                                    flex: 1,
                                    child: Text(
                                      _homeDataModel.detail[0].pointToday.round()
                                              .toString() ??
                                          '0',
                                      softWrap: true,
                                      style: TextStyle(
                            ...
                            child: Container(
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    _homeDataModel.detail[0].pointYesterday.round()
                                            .toString() ??
                                        '0',
                                    softWrap: true,
                                    textAlign: TextAlign.right,
                        ...
                        children: <Widget>[
                          Flexible(
                            ...
                            child: Container(
                              alignment: Alignment.centerRight,
                              child: Text(
                                _homeDataModel.detail[0].pointThisMonth.round()
                                        .toString() ??
                                    '0',
                                softWrap: true,
                                style: TextStyle(
                            ...
                            child: Container(
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    _homeDataModel.detail[0].pointLastMonth.round()
                                            .toString() ??
                                        '0',
                                    softWrap: true,
                                    style: TextStyle(
